...
if($dic=='All DIC'){
	...
	if($status=='open'){
		$sql="SELECT * FROM safety_adm_observation where date between '".$from."' and '".$to."' and status like '$status'";
	...
	if($status=='closed'){
		...
		$sql="SELECT * FROM safety_adm_observation o, safety_adm_closed_observations c where o.date between '".$from."' and '".$to."' and o.observation_id=c.observation_id";
		$spreadsheet = new Spreadsheet();
			$drawing = new \PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
			$spreadsheet->setActiveSheetIndex(0);
			$query=mysqli_query($link, $sql);
		...
		if($status=='all'){
			...
			$query=mysqli_query($link, $sql);
             ...
             $sql1="SELECT * FROM safety_adm_observation where date between '".$from."' and '".$to."' and status like 'open'";
...
if($status=='open'){
	...
	if($status=='closed'){
		...
		if($status=='all'){
			$sql="SELECT status FROM safety_adm_observation where date between '".$from."' and '".$to."' and dic like '$dic'";
			...
			$query=mysqli_query($link, $sql);
             ...
             $sql1="SELECT * FROM safety_adm_observation where date between '".$from."' and '".$to."' and dic like '$dic' and status like 'open'";
			$query1=mysqli_query($link, $sql1);
